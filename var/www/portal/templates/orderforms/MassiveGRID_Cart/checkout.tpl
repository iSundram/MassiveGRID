            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
                ...
                {if !$inExpressCheckout}
                    <div id="paymentGatewaysContainer" class="form-group">
                        ...
                        <div class="text-center">
                            {foreach $gateways as $gateway}
                                <label class="radio-inline payment-gateway-option{if $gateway.sysname eq 'payWithCredits'} w-hidden{/if}">
                                    <input type="radio"
                                           name="paymentmethod"
                    ...
                    <div class="cc-input-container{if $selectedgatewaytype neq "CC"} w-hidden{/if}" id="creditCardInputFields">
                        ...
                        <div class="row">
							<div class="form-group new-card-container col-md-12 col-md-offset-2" style="text-align: center;">
								<img src="assets/img/secure-payment-2-1.png" class="img-responsive" style="max-width: 400px; text-align: center;">
							</div>
						</div>
                    </div>
                {else}
